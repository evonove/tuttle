...
# django-tuttle is the root folder
...
WSGI_APPLICATION = 'tuttle.wsgi.application'

# database configuration
DATABASES_DEFAULT = 'postgres://devel:123456@127.0.0.1:5432/tuttle'
DATABASES = {
